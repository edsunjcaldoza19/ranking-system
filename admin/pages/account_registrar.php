                                ...
                                <table class="table" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $conn->prepare("SELECT * FROM `tbl_account_registrar`");
                                            $sql->execute();
                                            while($fetch = $sql->fetch()){
                                        ?>
                                            <tr>
                                                <td><?php echo $fetch['reg_name']?></td>
                                                <td><?php echo $fetch['reg_sex']?></td>
                                                <td><?php echo $fetch['reg_address']?></td>
                                                <td><?php echo $fetch['reg_birth_date']?></td>
                                                <td><?php echo $fetch['reg_email']?></td>
                                                <td><?php echo $fetch['reg_contact']?></td>
                                                <td>
                                                    <a href="account_registrar_update.php?id=<?php echo $fetch['id']; ?>" class="btn btn-primary btn rounded-pill">Update</a>
                                                </td>
                                        ...
                                        <?php
                                            include 'be/account_registrar/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
