    ...
    <?php include 'includes/left_sidebar.php'; ?>
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                                ...
                                <table class="table" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $conn->prepare("SELECT *, tbl_subject_branch_details.id FROM tbl_subject_branch_details
                                        ...
                                        <?php
                                            include 'be/subject_branch_details/updateModal.php';
                                            include 'be/subject_branch_details/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
                ...
                <?php
                    include 'be/subject_branch_details/addModal.php';
