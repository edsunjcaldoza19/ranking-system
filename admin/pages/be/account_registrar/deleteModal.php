...
<div class="modal fade text-left" id="deleteModal<?php echo $fetch['id']?>" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel110" aria-hidden="true">
        ...
        role="document">
            ...
            <form action="be/account_registrar/delete.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="staffImage" id="image" value="<?php echo $fetch['reg_image'] ?>">
