                ...
                <div class="page-heading">
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h3>Class List (Branch Subjects)</h3>
                            </div>
                            <div class="card-body">
                                <table class="table" id="table2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            WHERE `sbranch_teacher` = $getStaffID
                                            AND `sbranch_quarter_id` = $getQuarterID
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="class_branch_grade.php?sy_id=<?php echo $_GET['sy_id'];?>&&quarter_id=<?php echo $_GET['quarter_id']; ?>&&class_id=<?php echo $fetch['sbranch_class_id'];?>&&subject_id=<?php echo $fetch['id'];?>"
