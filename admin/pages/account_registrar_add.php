            ...
            <div id="main-content">
                <div class="page-heading">
                    ...
                    <section class="section">
                            <div class="card">
                                <div class="card-body">
                                    <form action="be/account_registrar/add.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <h4 class="card-title">Account Credentials</h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="staffPassword" placeholder="Enter Password" required>
                                            </div>
