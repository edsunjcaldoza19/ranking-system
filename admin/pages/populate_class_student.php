    ...
    <?php include 'includes/left_sidebar.php'; ?>
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="populate_class.php?sy_id=<?php echo $getSchoolYear;?>" class="btn btn-primary btn rounded-pill">
                                    Back to Class List
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-danger btn rounded-pill" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $fetch['id']?>">Remove</button>
                                                </td>
                                            </tr>
                                        <?php
                                            include 'be/populate_class_student/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
                ...
                <?php
                    include 'be/populate_class_student/addModal.php';
