    ...
    <?php include 'includes/left_sidebar.php'; ?>
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                                ...
                                <table class="table" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            LEFT JOIN tbl_account_staff ON
                                            tbl_account_staff.id=tbl_subject.subject_teacher
                                            WHERE subject_class_id = $getClassID AND subject_quarter_id = $getQuarterID");
                                            $sql->execute();
                                        ...
                                        <?php
                                            include 'be/subject/updateModal.php';
                                            include 'be/subject/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
                ...
                <?php
                    include 'be/subject/addModal.php';
