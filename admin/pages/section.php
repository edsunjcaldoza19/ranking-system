    ...
    <?php include 'includes/left_sidebar.php'; ?>
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">Configure Sections</p>
                            </div>
                                ...
                                <table class="table" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $conn->prepare("SELECT *, tbl_section.id FROM
                                            tbl_section LEFT JOIN tbl_grade_level ON
                                        ...
                                        <?php
                                            include 'be/section/updateModal.php';
                                            include 'be/section/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
                ...
                <?php
                    include 'be/section/addModal.php';
