                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?></td>
                                                <td>
                                                    <a href="ranking_subject_student_branch.php?sy_id=<?php echo $_GET['sy_id'];?>&&quarter_id=<?php echo $_GET['quarter_id']; ?>&&class_id=<?php echo $_GET['class_id'];?>&&subject_id=<?php echo $fetch['id'];?>"
                                                    class="btn btn-primary btn rounded-pill mt-2">Select</a>
                                                </td>
                                            </tr>
                                        <?php
