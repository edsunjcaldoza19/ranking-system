    <!-- Add Modal -->
    <form action="be/grade_branch/add.php?sy_id=<?php echo $_GET['sy_id'];?>&&quarter_id=<?php echo $_GET['quarter_id']; ?>&&class_id=<?php echo $_GET['class_id'];?>&&subject_id=<?php echo $_GET['subject_id'];?>" method="POST" enctype="multipart/form-data">
