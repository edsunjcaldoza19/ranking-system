...
<div class="modal fade text-left" id="updateModal<?php echo $fetch['id']?>" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel110" aria-hidden="true">
        ...
        role="document">
            ...
            <form action="be/grade_branch/update.php?sy_id=<?php echo $_GET['sy_id'];?>&&quarter_id=<?php echo $_GET['quarter_id']; ?>&&class_id=<?php echo $_GET['class_id'];?>&&subject_id=<?php echo $_GET['subject_id'];?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                            ...
                            ?>
                                <option <?php if($fetch['gbranch_stud_id'] == $fetchClass['pop_stud_id'])
                        ...
                        <div class="form-group">
                            <label>Grade</label>
                            <input type="text" value="<?php echo $fetch['gbranch_grade']; ?>" class="form-control" name="grade" placeholder="Enter Grade">
                        </div>
                </div>
