                                ...
                                <div class="card animate__animated animate__fadeInUp">
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <hr>
                                            <h4><?php echo $fetch['reg_name']; ?></h4>
                                            <p class="card-text">
                                                <i class="bi bi-envelope-fill"></i>
                                                <?php echo $fetch['reg_email']?>
                                            </p>
                                            <p class="card-text">
                                                <i class="bi bi-telephone-inbound-fill"></i>
                                                <?php echo $fetch['reg_contact']?>
                                            </p>
                                            <p class="card-text">
                                                <i class="bi bi-house-fill"></i>
                                                <?php echo $fetch['reg_address']?>
                                            </p>
                                        </div>
                                            <?php
                                    ...
                                    <div class="card-footer d-flex justify-content-between">
                                        ...
                                        <a href="account_registrar_update.php?id=<?php echo $fetch['id']; ?>" class="btn btn-primary">Update</a>
                                    </div>
                                </div>
                            </div>
                            <?php
