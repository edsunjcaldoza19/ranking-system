...
<div class="modal fade text-left" id="updateModal<?php echo $fetch['id']?>" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel110" aria-hidden="true">
        ...
        role="document">
            ...
            <form action="be/subject_branch/update.php?sy_id=<?php echo $_GET['sy_id'];?>&&class_id=<?php echo $_GET['class_id'];?>&&quarter_id=<?php echo $_GET['quarter_id'];?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <label>Subject Name</label>
                            ...
                            <?php
                                ...
                                $sqlSubject = $conn->prepare("SELECT * FROM `tbl_subject_branch_details`");
                                $sqlSubject->execute();
                                while($fetchSubject = $sqlSubject->fetch()){
                            ?>
                                <option value="<?php echo $fetchSubject['id'] ?>"
                                <?php
                                if($fetchSubject['id'] == $fetch['sbranch_subject_id']){
                                    echo 'selected';
                                }
                                ?>
                                ><?php echo $fetchSubject['sbranch_name'] ?></option>
                            <?php
                                }
                            ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            ?>
                                ...
                                <?php
                                if($fetchTeacher['id'] == $fetch['sbranch_teacher']){
                                    echo 'selected';
                                }
                                ?>
