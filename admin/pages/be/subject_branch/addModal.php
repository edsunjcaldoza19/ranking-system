    <!-- Add Modal -->
    <form action="be/subject_branch/add.php?sy_id=<?php echo $_GET['sy_id'];?>&&class_id=<?php echo $_GET['class_id'];?>&&quarter_id=<?php echo $_GET['quarter_id'];?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <div class="form-group">
                            ...
                            ?>
                                <option value="<?php echo $fetch['id'] ?>"><?php echo $fetch['sbranch_name'] ?></option>
                            <?php
                                }
                            ?>
                            </select>
