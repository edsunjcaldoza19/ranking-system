...
<body>
    ...
    <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <?php
                                            ...
                                            LEFT JOIN tbl_subject_branch_details
                                            ON tbl_subject_branch_details.id = tbl_subject_branch.sbranch_subject_id
                                            WHERE tbl_subject_branch.id = $subjectID");
                                            $sql->execute();
                                            $fetch = $sql->fetch();
                                        ?>
                                <h3><?php echo $fetch['sbranch_name']; ?></h3>
                                ...
                                <table class="table" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            WHERE `gbranch_subject_id` = $subjectID");
                                            $sql->execute();
                                        ...
                                        <?php
                                            include 'be/grade_branch/updateModal.php';
                                            include 'be/grade_branch/deleteModal.php';
                                            };
                                        ?>
                                    </tbody>
                                </table>
                ...
                <?php
                    include 'be/grade_branch/addModal.php';
